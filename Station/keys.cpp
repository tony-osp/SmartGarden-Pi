...
{
  uint8_t          key;
  static uint8_t   oldkey=BUTTON_NONE;
  static uint8_t   autorepeat_sent = 0;   // internal flag to track auto-repeat

  static uint8_t   state = 0;             // internal state
