...
#include <inttypes.h>
#include "port.h"	// platform definitions

extern SerialClass Serial;	// external reference to Serail. Since RPi does not have this global object, it is defined in XBeeRF.cpp
