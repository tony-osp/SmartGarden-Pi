...
Note: Basic watering Log operation signature is implemented to be compatible with the MySql-based logging in sprinklers_pi control program.
...
#define WATERING_LOG_DIR_LEN		14
...
#define TEMPERATURE_LOG_DIR_LEN	 	 11
...
#define HUMIDITY_LOG_DIR_LEN	  11
...
#define PRESSURE_LOG_DIR_LEN	  14
