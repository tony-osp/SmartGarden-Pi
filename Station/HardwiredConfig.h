...
// use this definition for RPi - based Master station 
#if SG_HARDWARE == HW_V20_MASTER
#define LOCAL_NUM_DIRECT_CHANNELS	1
#define PARALLEL_PIN_OUT_MAP {28 }
// LCD
#endif //HW_V20_MASTER
...
//Large-screen LCD on v20 Master (Raspberry Pi)
#if SG_HARDWARE == HW_V20_MASTER
#define PIN_LCD_D4         21    // LCD d4 pin
#define PIN_LCD_D5         22    // LCD d5 pin
#define PIN_LCD_D6         23	 // LCD d6 pin
#define PIN_LCD_D7         24    // LCD d7 pin
#define PIN_LCD_EN         25    // LCD enable pin
#define PIN_LCD_RS         26    // LCD rs pin
#endif //HW_V15_MASTER
...
#elif SG_HARDWARE == HW_V20_MASTER

#define PIN_BUTTON_1      0    // button 1
#define PIN_BUTTON_2      3    // button 2
#define PIN_BUTTON_3      2    // button 3
#define PIN_BUTTON_4      1    // button 4
