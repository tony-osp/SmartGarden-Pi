...
#define HW_V20_MASTER			20	// Master station, RPi hardware version 2.0 (basic - no RF)
...
#define SG_HARDWARE				HW_V20_MASTER
...
#define EEPROM_SHEADER "SG20"
#define SG_FIRMWARE_VERSION	30
